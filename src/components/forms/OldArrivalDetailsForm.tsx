...
const OldArrivalDetailsForm = (params: any) => {
    ...
    return <SectionFrame title={'Arrival or Pickup Details'}>
        <div className="form-sub-title">
            ...
            <select className="form-select" required={true}
                    defaultValue={bookingService.arrivalBookingDetails.getPickUpPoint() ?? "SELECTED"}
            ...
            <select className="form-select" required={true}
                    defaultValue={bookingService.arrivalBookingDetails.getDropPoint() ?? "SELECTED"}
                    aria-label="Default select example" onChange={async (e) => {
            ...
            <input type="text" className="form-control" id="flight-coming-from"
                   ...
                   onChange={(e) => bookingService.arrivalBookingDetails.setFlightComeFrom(e.target.value)}/>
            ...
            <input type="text" className="form-control" id="flight-num"
                   ...
                   onChange={(e) => bookingService.arrivalBookingDetails.setFlightNumberStr(e.target.value)}/>
        </div>
    </SectionFrame>
}

export default OldArrivalDetailsForm;
