...
export class DataExtractUtils{
    ...
    public static getBookedDate(snap:QueryDocumentSnapshot):Date{
        return snap.data().personalDetails.created.toDate();
    }
    ...
    public static getTripDate(snap:QueryDocumentSnapshot):Date{
        if(snap.data().journeyType === 0){
            return snap.data().arrival.pickUpDate.toDate();
        }else if(snap.data().journeyType === 1){
            return snap.data().arrival.pickUpDate.toDate();
        }else{
            return snap.data().departure.pickUpDate.toDate();
        }
    }
